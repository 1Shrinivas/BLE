 ...
 **************************************************************************
 */
#define USER_CFG_ADDRESS_MODE      APP_CFG_ADDR_STATIC //APP_CFG_CNTL_PRIV_RPA_RAND

//For Public MAC ID USER_CFG_ADDRESS_MODE should be--> APP_CFG_ADDR_PUB
//For Random MAC ID USER_CFG_ADDRESS_MODE should be--> APP_CFG_CNTL_PRIV_RPA_RAND

#define APP_CUSTS1_SEC_REQ  SRV_PERM_AUTH // Sandeep
